...
#[allow(dead_code)]
pub const PKG_VERSION: &str = r"0.4.2";
...
#[allow(dead_code)]
pub const PKG_AUTHORS: &str = r"John Gallagher <johnkgallagher@gmail.com>";
#[doc=r#"The name of the package."#]
#[allow(dead_code)]
pub const PKG_NAME: &str = r"amiquip";
#[doc=r#"The description."#]
#[allow(dead_code)]
pub const PKG_DESCRIPTION: &str = r"Pure Rust RabbitMQ client";
#[doc=r#"The homepage."#]
#[allow(dead_code)]
...
#[allow(dead_code)]
pub const PKG_REPOSITORY: &str = r"https://github.com/jgallagher/amiquip";
...
#[allow(dead_code)]
pub const RUSTC: &str = r"/Users/Sabina_1/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub const RUSTDOC: &str = r"/Users/Sabina_1/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc";
...
#[allow(dead_code)]
pub const FEATURES: [&str; 2] = ["DEFAULT", "NATIVE_TLS"];
#[doc=r#"The features as a comma-separated string."#]
#[allow(dead_code)]
pub const FEATURES_STR: &str = r"DEFAULT, NATIVE_TLS";
#[doc=r#"The output of `/Users/Sabina_1/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustc -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.94.1 (e408947bf 2026-03-25)";
#[doc=r#"The output of `/Users/Sabina_1/.rustup/toolchains/stable-aarch64-apple-darwin/bin/rustdoc -V`"#]
#[allow(dead_code)]
pub const RUSTDOC_VERSION: &str = r"rustdoc 1.94.1 (e408947bf 2026-03-25)";
